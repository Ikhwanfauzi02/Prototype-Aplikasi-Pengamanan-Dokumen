...
?>
  <head>
    <title><?php echo $data['fullname']; ?> - Dekripsi File Dokumen</title>
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="index.php" style="font-size:18pt; font-family: Times new roman; background-color: #2F4F4F;"><span>KRIPTO</span></a>
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          <div class="user-panel">
            <div class="pull-left image"><img class="img-circle" src="../assets/images/lockandkey2.png" alt="User Image"></div>
			...
			<ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        <a href="#" style="border-color:#fff;background-color: #778899;"><i class="fa fa-file-o"></i><span>File</span><i class="fa fa-angle-right"></i></a>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              if ($data['status'] == 1) {
                                ...
                                echo '<a href="#" class="btn btn-success">Enkripsi File</a>';
                              }else {
