...
<body class="sidebar-mini fixed">
    <div class="wrapper">
        <header class="main-header hidden-print">
            <a class="logo" href="index.php" style="font-size:18pt; font-family: Times new roman; background-color: #2F4F4F;">
                <span>KRIPTO</span>
            </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($data['status'] == 2) {
                                                    echo '<a href="download.php?file=' . urlencode($data['file_name_source']) . '" class="btn btn-warning btn-xs"><i class="fa fa-download"></i> Download</a>';
                                                } ?>
                                                <?php if ($data['status'] == 1) {
                                                    echo '<a href="downloadencrypt.php?file=' . urlencode($data['file_name_finish']) . '" class="btn btn-warning btn-xs"><i class="fa fa-download"></i> Download</a>';
                                                } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
